...
@section('content')
<div class="min-h-screen p-6 lg:p-10 bg-[#F8FAFC] dark:bg-gray-950">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                <form action="{{ route('guru.profile.update') }}" method="POST" class="bg-white dark:bg-gray-900 p-10 rounded-[3rem] border border-emerald-50 dark:border-emerald-900/30 shadow-xl shadow-emerald-900/5 relative overflow-hidden transition-all duration-500 hover:shadow-emerald-900/10">
                    @csrf @method('PATCH')
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                <label class="text-xs font-black text-emerald-900 dark:text-emerald-400 uppercase tracking-widest ml-1">Email</label>
