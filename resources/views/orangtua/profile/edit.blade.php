...
<div class="min-h-screen p-6 lg:p-10">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
            <div>
                <h1 class="text-4xl font-black text-slate-900 tracking-tight">Profil <span class="text-indigo-600">Orang Tua</span></h1>
                <p class="text-slate-500 font-semibold italic mt-1">Kelola informasi pribadi dan keamanan akun Anda</p>
            </div>
            <div class="px-6 py-3 bg-white border border-indigo-100 rounded-2xl shadow-sm text-indigo-600 font-black text-xs uppercase tracking-widest">
                Akses Portal: {{ strtoupper(auth()->user()->role) }}
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                <form action="{{ route('orangtua.profile.update') }}" method="POST" class="bg-white p-10 rounded-[3rem] border border-indigo-50 shadow-xl shadow-indigo-900/5 relative overflow-hidden transition-all duration-500 hover:shadow-indigo-900/10">
                    @csrf @method('PUT')
                    ...
                    <div class="flex items-center gap-4 mb-10">
                        ...
                        <h3 class="text-2xl font-black text-slate-800">Biodata Diri</h3>
                    </div>

                    <div class="space-y-6">
                        <div class="space-y-2">
                            <label class="text-xs font-black text-indigo-900 uppercase tracking-widest ml-1">Nama Lengkap</label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                <label class="text-xs font-black text-indigo-900 uppercase tracking-widest ml-1">Email Aktif</label>
            ...
            {{-- Sisi Kanan: Password --}}
            <div class="space-y-8">
                <form action="{{ route('orangtua.profile.password') }}" method="POST" class="group bg-slate-900 p-8 rounded-[3rem] shadow-2xl shadow-indigo-900/20 text-white relative overflow-hidden transition-all duration-500">
                    @csrf @method('PUT')
                    ...
                    <div class="space-y-6 relative z-10">
                        ...
                        <div class="space-y-2">
                            <label class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] block ml-1">Konfirmasi Password Baru</label>
