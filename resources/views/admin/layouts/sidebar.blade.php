                    ...
                    <ul class="space-y-1.5">
                        ...
                        <li>
                            <a href="{{ url('/admin/hasil') }}" 
                               class="flex items-center px-4 py-3 text-sm font-bold rounded-2xl transition-all duration-200 group {{ request()->is('admin/hasil*') ? 'bg-blue-600 text-white shadow-lg shadow-blue-200' : 'text-gray-500 hover:bg-blue-50 hover:text-blue-600 dark:text-gray-400 dark:hover:bg-gray-800' }}">
                                <i class="fa-solid fa-file-medical w-5 h-5 flex items-center justify-center transition-colors {{ request()->is('admin/hasil*') ? 'text-white' : 'text-gray-400 group-hover:text-blue-600' }}"></i>
...
<div class="fixed inset-0 z-20 hidden bg-gray-900/40 backdrop-blur-sm transition-opacity" id="sidebarBackdrop"></div>